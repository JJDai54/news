...
define('_AM_NEWS_DBUPDATED', 'Database updated successfully!');
define('_AM_NEWS_CONFIG', 'News configuration');
define('_AM_NEWS_AUTOARTICLES', 'Automated articles');
define('_AM_NEWS_STORYID', 'Story ID');
define('_AM_NEWS_TITLE', 'Title');
define('_AM_NEWS_TOPIC', 'Topic');
define('_AM_NEWS_POSTER', 'Poster');
define('_AM_NEWS_PROGRAMMED', 'Programmed Date/Time');
define('_AM_NEWS_ACTION', 'Action');
define('_AM_NEWS_EDIT', 'Edit');
define('_AM_NEWS_DELETE', 'Delete');
define('_AM_NEWS_LAST10ARTS', 'Last %d articles');
define('_AM_NEWS_PUBLISHED', 'Published'); // Published Date
define('_AM_NEWS_GO', 'Go!');
define('_AM_NEWS_EDITARTICLE', 'Edit article');
define('_AM_NEWS_POSTNEWARTICLE', 'Post new article');
define('_AM_NEWS_ARTPUBLISHED', 'Your article has been published!');
define('_AM_NEWS_HELLO', 'Hello %s,');
define('_AM_NEWS_YOURARTPUB', 'Your article submitted to our site has been published.');
define('_AM_NEWS_TITLEC', 'Title: ');
define('_AM_NEWS_URLC', 'URL: ');
define('_AM_NEWS_PUBLISHEDC', 'Published: ');
define('_AM_NEWS_RUSUREDEL', 'Are you sure you want to delete this article and all its comments?');
define('_AM_NEWS_YES', 'Yes');
define('_AM_NEWS_NO', 'No');
define('_AM_NEWS_INTROTEXT', 'Intro text');
define('_AM_NEWS_EXTEXT', 'Extended text');
define('_AM_NEWS_ALLOWEDHTML', 'Allowed HTML:');
define('_AM_NEWS_DISAMILEY', 'Disable smiley');
define('_AM_NEWS_DISHTML', 'Disable HTML');
define('_AM_NEWS_APPROVE', 'Approve');
define('_AM_NEWS_MOVETOTOP', 'Move this story to top');
define('_AM_NEWS_CHANGEDATETIME', 'Change the date/time of publication');
define('_AM_NEWS_NOWSETTIME', 'It is now set at: %s'); // %s is datetime of publish
define('_AM_NEWS_CURRENTTIME', 'Current time is: %s');  // %s is the current datetime
define('_AM_NEWS_SETDATETIME', 'Set the date/time of publish');
define('_AM_NEWS_MONTHC', 'Month:');
define('_AM_NEWS_DAYC', 'Day:');
define('_AM_NEWS_YEARC', 'Year:');
define('_AM_NEWS_TIMEC', 'Time:');
define('_AM_NEWS_PREVIEW', 'Preview');
//define('_AM_NEWS_SAVE', 'Save');
define('_AM_NEWS_PUBINHOME', 'Publish in home?');
define('_AM_NEWS_ADD', 'Add');
//%%%%%%    Admin Module Name  Topics   %%%%%
define('_AM_NEWS_ADDMTOPIC', 'Add a main topic');
define('_AM_NEWS_TOPICNAME', 'Topic name');
// Warning, changed from 40 to 255 characters.
define('_AM_NEWS_MAX40CHAR', '(max: 255 characters)');
define('_AM_NEWS_TOPICIMG', 'Topic image');
define('_AM_NEWS_IMGNAEXLOC', 'image name + extension located in %s');
define('_AM_NEWS_FEXAMPLE', 'for example: games.gif');
define('_AM_NEWS_ADDSUBTOPIC', 'Add a subtopic');
define('_AM_NEWS_IN', 'in');
define('_AM_NEWS_MODIFYTOPIC', 'Modify topic');
define('_AM_NEWS_MODIFY', 'Modify');
define('_AM_NEWS_PARENTTOPIC', 'Parent topic');
define('_AM_NEWS_SAVECHANGE', 'Save changes');
define('_AM_NEWS_DEL', 'Delete');
define('_AM_NEWS_CANCEL', 'Cancel');
define('_AM_NEWS_WAYSYWTDTTAL', 'Warning: Are you sure you want to delete this topic and all its stories and comments?');
// Added in Beta6
define('_AM_NEWS_TOPICSMNGR', 'Topics manager');
define('_AM_NEWS_PEARTICLES', 'Post/Edit articles');
define('_AM_NEWS_NEWSUB', 'New submissions');
define('_AM_NEWS_POSTED', 'Posted');
...
define('_AM_NEWS_EXPARTS', 'Expired Articles');
define('_AM_NEWS_EXPIRED', 'Expired');
define('_AM_NEWS_CHANGEEXPDATETIME', 'Change the date/time of expiration');
define('_AM_NEWS_SETEXPDATETIME', 'Set the date/time of expiration');
define('_AM_NEWS_NOWSETEXPTIME', 'It is now set at: %s');
// Added in RC3
define('_AM_NEWS_ERRORTOPICNAME', 'You must enter a topic name!');
define('_AM_NEWS_EMPTYNODELETE', 'Nothing to delete!');
// Added 240304 (Mithrandir)
define('_AM_NEWS_GROUPPERM', 'Submit/Approve/View permissions');
define('_AM_NEWS_SELFILE', 'Select file to upload');
// Added by Hervé
define('_AM_NEWS_UPLOAD_DBERROR_SAVE', 'Error while attaching file to the story');
define('_AM_NEWS_UPLOAD_ERROR', 'Error while uploading the file');
define('_AM_NEWS_UPLOAD_ATTACHFILE', 'Attached file(s)');
define('_AM_NEWS_APPROVEFORM', 'Approve permissions');
define('_AM_NEWS_SUBMITFORM', 'Submit permissions');
define('_AM_NEWS_VIEWFORM', 'View permissions');
define('_AM_NEWS_APPROVEFORM_DESC', 'Select, who can approve news');
define('_AM_NEWS_SUBMITFORM_DESC', 'Select, who can submit news');
define('_AM_NEWS_VIEWFORM_DESC', 'Select, who can view which topics');
define('_AM_NEWS_DELETE_SELFILES', 'Delete selected files');
define('_AM_NEWS_TOPIC_PICTURE', 'Upload picture');
define('_AM_NEWS_UPLOAD_WARNING', '<b>Warning, do not forget to apply write permissions to the following folder : %s</b>');
...
define('_AM_NEWS_ADD_TOPIC', 'Add a topic');
define('_AM_NEWS_ADD_TOPIC_ERROR', 'Error, topic already exists!');
define('_AM_NEWS_ADD_TOPIC_ERROR1', 'Error: Cannot select this topic for parent topic!');
define('_AM_NEWS_SUB_MENU', 'Publish this topic as a sub menu');
define('_AM_NEWS_SUB_MENU_YESNO', 'Submenu?');
define('_AM_NEWS_HITS', 'Hits');
define('_AM_NEWS_CREATED', 'Created');
define('_AM_NEWS_TOPIC_DESCR', "Topic's description");
define('_AM_NEWS_USERS_LIST', 'Users list');
define('_AM_NEWS_PUBLISH_FRONTPAGE', 'Publish in front page?');
