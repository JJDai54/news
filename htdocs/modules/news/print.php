...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo _LANGCODE; ?>" lang="<?php echo _LANGCODE; ?>">
    <?php
    echo "<head>\n";
    echo '<title>' . $myts->htmlSpecialChars($story->title()) . ' - ' . _MD_NEWS_PRINTER . ' - ' . $myts->htmlSpecialChars($story->topic_title()) . ' - ' . $xoopsConfig['sitename'] . '</title>';
    ...
    if (NewsUtility::getModuleOption('footNoteLinks')) {
        ...
        <script type="text/javascript">
            ...
            function footnoteLinks(containerID, targetID) {
                ...
                var h2_txt = document.createTextNode('<?php echo _MD_NEWS_LINKS; ?>');
    ...
    <br><br>';
    printf(_MD_NEWS_THISCOMESFROM, htmlspecialchars($xoopsConfig['sitename'], ENT_QUOTES));
    echo '<br><a href="' . XOOPS_URL . '/">' . XOOPS_URL . '</a><br><br>
        ' . _MD_NEWS_URLFORSTORY . ' <!-- Tag below can be used to display Permalink image --><!--img src="' . XOOPS_URL . '/modules/' . $xoopsModule->dirname() . '/assets/images/x.gif" /--><br>
