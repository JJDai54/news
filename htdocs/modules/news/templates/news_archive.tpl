            ...
            <{foreach item=story from=$stories}>
                <tr class="<{cycle values="even,odd"}>">
                    ...
                    <td align="center"><a title="<{$lang_printer}>" href="<{$story.print_link}>" rel="nofollow"><img
                                    src="<{xoModuleIcons16}>/printer.png" border="0" alt="<{$lang_printer}>"></a>
                        <a title="<{$lang_sendstory}>" href="<{$story.mail_link}>" target="_top"><img
                                src="<{xoModuleIcons16}>/mail_forward.png" border="0" alt="<{$lang_sendstory}>"></a>
                    </td>
