...
define("_MI_NEWS_SHOWICONS_PDF","Afficher l'icônes créer un PDF ?");
define("_MI_NEWS_SHOWICONS_PDF_DSC","Affiche l'icônes du PDF en bas de chaque article");
...
//JJDai
define("_MI_NEWS_BLOCKS","Blocks");
define("_MI_NEWS_PREFERENCE","Préférences");

//help multi-page
define('_MI_NEWS_DISCLAIMER', 'Avertissement');
define('_MI_NEWS_LICENSE', 'Licence');
...
define('_MI_NEWS_CSS_FOLDER',"Emplacement des feuiles de style");
define('_MI_NEWS_CSS_FOLDER_DESC',"Les feuilles de styles peuvent être placées dans un dossier commun pour être utilisées par d'autres modules.<br>Laisser vide utilise des feuille CSS du module par défaut.<br>Le chemin doit être indiqué par rapport à la racine du site.");

//JJDai
define ('_MI_NEWS_COLOR_SET', 'Jeu de couleurs');
define ('_MI_NEWS_COLOR_SET_DESC', 'Défini le jeu de couleur par défaut des articles. Les jeux de couleurs sont définis dans le CSS "style-item-color.css" du module ou du theme ou du framework JJD (voir les options du module)');
