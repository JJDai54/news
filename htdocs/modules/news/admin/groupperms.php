...
switch ($permtoset) {
    case 1:
        $title_of_form = _AM_NEWS_APPROVEFORM;
        $perm_name     = 'news_approve';
        $perm_desc     = _AM_NEWS_APPROVEFORM_DESC;
        break;
    case 2:
        $title_of_form = _AM_NEWS_SUBMITFORM;
        $perm_name     = 'news_submit';
        $perm_desc     = _AM_NEWS_SUBMITFORM_DESC;
        break;
    case 3:
        $title_of_form = _AM_NEWS_VIEWFORM;
        $perm_name     = 'news_view';
        $perm_desc     = _AM_NEWS_VIEWFORM_DESC;
        break;
}
...
if ($alltopics) {
    ...
    redirect_header('index.php?op=topicsmanager', 5, _MD_NEWS_NEWS_NO_TOPICS, false);
}
