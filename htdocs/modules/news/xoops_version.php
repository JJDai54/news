...
include_once XOOPS_ROOT_PATH . '/modules/news/include/constantes.php';
...
$modversion['release_date']  = '2023/10/15';
...
++$i; //JJDai
$modversion['templates'][$i]['file']        = 'news_topic_color_set.tpl';
$modversion['templates'][$i]['description'] = 'Legendes des categories';
...
/**
 * Comptage des lecture des admins
 */
++$i;
$modversion['config'][$i]['name']        = 'countAdminRead';
$modversion['config'][$i]['title']       = '_MI_COUNT_ADMIN_READ';
$modversion['config'][$i]['description'] = '_MI_COUNT_ADMIN_READ_DESC';
$modversion['config'][$i]['formtype']    = 'yesno';
$modversion['config'][$i]['valuetype']   = 'int';
$modversion['config'][$i]['default']     = 0;
...
$modversion['config'][] = ['name' => 'color_set',
                          'title' => '_MI_NEWS_COLOR_SET',
                    'description' => '_MI_NEWS_COLOR_SET_DESC',
                       'formtype' => 'select',
                      'valuetype' => 'text',
                        'options' => news_get_css_color(),
                        'default' => ''];



$modversion['config'][] = ['name' => 'displayTemplateName',
                    'title'       => '_MI_NEWS_SHOW_TPL_NAME',
                    'description' => '_MI_NEWS_SHOW_TPL_NAME_DESC',
                    'formtype'    => 'yesno',
                    'valuetype'   => 'int',
                    'default'     => 0];
