...
class MyXoopsTopic
{
     ...
     * @param $value
     */
    public function setTopicWeight($value)
    {
        $this->topic_weight = $value;
    }
    ...
    {
        $result = $this->db->query('SELECT topic_id, topic_pid, topic_title FROM ' . $this->table  . " ORDER BY topic_weight, topic_title");
        $ret    = [];
        $myts   = MyTextSanitizer::getInstance();
